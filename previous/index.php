  ...
  <div id="featured_slide"> 
    ...
    <ol>
      <li>
        ...
        <div><img src="images/featured-slide/CVS.jpg" alt="" /></div>
      </li>
      <li>
    ...
    <div id="homepage" class="clear">
      <div class="fl_left">
        ...
        <div id="hpage_gallery">
          <ul class="clear">
            <li><a href="#"><img src="images/175x130.gif" alt="" /></a></li>
            <li class="last"><a href="#"><img src="images/175x130.gif" alt="" /></a></li>
            <li><a href="#"><img src="images/175x130.gif" alt="" /></a></li>
            <li class="last"><a href="#"><img src="images/175x130.gif" alt="" /></a></li>
          </ul>
        </div>
      ...
      <div class="fl_right">
        ...
        <div id="hpage_latestnews">
          <ul>
            <li>
              <div class="imgl"><img src="images/160x80.gif" alt="" /></div>
              <p class="latestnews">This is a W3C compliant latest news lorem ipsum <a href="#" >University of Delhi</a>. You must be comfortable with <a href="#">CVS</a>.</p>
              <p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
            </li>
            <li>
              <div class="imgl"><img src="images/160x80.gif" alt="" /></div>
              <p class="latestnews">DO what you want to do. Come back to CVS. Lorem IPsum. Description for all. Please visit <a href="#">CVS</a>.</p>
              <p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
            </li>
            <li class="last">
              <div class="imgl"><img src="images/160x80.gif" alt="" /></div>
        ...
        <div id="hpage_specials" class="clear">
          <ul>
            <li>
              ...
              <div class="box">
                <div class="imgholder"><img src="images/160x160.gif" alt="" /></div>
            ...
            <li>
              ...
              <div class="box">
                ...
                <div class="imgholder"><img src="images/160x80.gif" alt="" /></div>
