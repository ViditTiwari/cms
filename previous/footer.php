<div class="wrapper row5">
  <div id="footer" class="clear"> 
    ...
    <div class="foot_contact">
      <h2>College of Vocational Studies</h2>
      <address>
      Triveni<br />
      Sheikh Sarai-II<br />
      New Delhi<br />
      ...
      <ul>
        <li><strong>Tel:</strong> 011 29258544, 011 29258792</li>
        <li><strong>Fax:</strong> 29256117</li>
        <li class="last"><strong>Email</strong> (principal): <a href="#">du.cvs.principal@gmail.com</a></li>
        <li class="last"><strong>Email</strong> (general queries): <a href="#">cvs_1972@yahoo.com</a></li>
      </ul>
    </div>
    <div class="footbox">
