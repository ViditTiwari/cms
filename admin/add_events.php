...
<?php
    ...
    $date = $_POST['event_date'];
		...
		$msg= check_events_page($pagename, $description, $date);
                 ...
                 <form  role="form" method="post" action="">
                  ...
                  <h4>Choose Page to add</h4>
                    ...
                    <div class="form-group">
                     <input class="form-control" type="date" name="event_date" placeholder="Type the Event Date">
                  
                    </div>
                    <div class="form-group">
                     <input class="form-control" type="text" name="description" placeholder="Type the Event Description">
